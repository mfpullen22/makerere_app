...
class ViewSurvey extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final totalScore = results["patientCare"]["pcTotal"] +
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      results["medicalKnowledge"]["mk1"].toInt().toString(),
                    )
                  ],
                ),
                Row(
                ...
                Row(
                  children: [
                    ...
                    Text(
                      results["medicalKnowledge"]["mk2"].toInt().toString(),
                    )
                  ],
                ),
                Row(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      results["interpersonal"]["ics1"].toInt().toString(),
                    )
                  ],
                ),
                Row(
                ...
                Row(
                  children: [
                    ...
                    Text(
                      results["interpersonal"]["ics2"].toInt().toString(),
                    )
                  ],
                ),
                Row(
                ...
                Row(
                  children: [
                    ...
                    Text(
                      results["interpersonal"]["ics3"].toInt().toString(),
                    )
                  ],
                ),
                Row(
